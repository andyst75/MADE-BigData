...
4. Проверим результат работы    
    ...
    Посмотрим на данные:
        ...
        var	57674.02524696099


    Мы видим, что рассчитанные через map-reduce данные совпадают с прямым расчетом. Для дисперсии расхождение начинается с 9го знака после запятой. Данное различие может быть вызвано различными методиками расчета.
